...
import {
  ...
  getAllRentedAreas,
  getTheRestArea,
  updateRegisterdRentedArea,
} from "../redux/actions/rented_area";
...
function RentedArea() {
  ...
  console.log(rentedAreaFromReducer);
  ...
  const editRegisterdRentedArea = (item) => {
    if (item) {
      ...
      dispatch(
        updateRegisterdRentedArea(
          copyOfRegisteredRentedArea.id,
          copyOfRegisteredRentedArea
        )
      );
      cancelClick();
      setTimeout(() => {
          ...
          <div className="form-post">
            ...
            <div className="form-post__content">
              <div className="form-post__wrapper">
                ...
                <div className="form-post__field">
                  <p style={{ textAlign: "left" }}>
                    <strong>Diện tích thuê:</strong> {rentedArea}
                  </p>
                </div>
                <div className="form-post__field">
                  <p style={{ textAlign: "left" }}>
                    <strong>Ngày bắt đàu:</strong>{" "}
                    {moment(rentedDate).format("DD-MM-YYYY")}
                  </p>
                </div>
                <div className="form-post__field">
                  <p style={{ textAlign: "left" }}>
              ...
              <div className="form-post__control">
                ...
                <button
                  ...
                  onClick={() => editRegisterdRentedArea(registeredRentedArea)}
                >
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        <button
                          ...
                          onClick={() => removeRentedArea(item.id)}
                        >
