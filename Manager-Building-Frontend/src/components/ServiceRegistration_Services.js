...
import {
  getALLServicesToAdd,
  registerServiceForCompany,
  getAllRegisterdServices,
  getServicesForRegistrationByName,
...
function ServiceRegistration_Services() {
  ...
  const registerdServices = useSelector(
    (state) => state.registeredService.data
  );
  ...
  const registerService = (item) => {
    if (item) {
      ...
      dispatch(
        registerServiceForCompany(companyId, item.id, serviceRegistratrion)
      );
      setIconLoad(true);
      setTimeout(() => {
        setDoneRegistration(true);
        navigate(
          `/service-registration/registered-services/?companyId=${companyId}`
        );
      }, 500);
    }
  };
          ...
          <div className="form-post">
            ...
            <div className="form-post__content">
              <div className="form-post__wrapper">
                ...
                <div className="form-post__field">
                  <p style={{ textAlign: "left" }}>
                    <strong>Tên dịch vụ:</strong> {serviceToRegister?.name}
                  </p>
                </div>
                <div className="form-post__field">
                  <p style={{ textAlign: "left" }}>
                    ...
                    {new Intl.NumberFormat("vi-VN", {
                      style: "currency",
                      currency: "VND",
                    }).format(serviceToRegister?.price)}
                  </p>
                </div>
                <div className="form-post__field">
                  <p style={{ textAlign: "left" }}>
              ...
              <div className="form-post__control">
                ...
                <button
                  ...
                  onClick={() => registerService(serviceToRegister)}
                >
        ...
        >
          <div className="admin-post__wrapper">
            <div className="admin-post__head">
              ...
              >
                Đăng ký thêm dịch vụ cho công ty:{" "}
