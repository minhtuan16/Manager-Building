...
const Company = () => {
  ...
  const editClick = (index) => {
    ...
    document.getElementById("authorized-capital").value =
      companies[index].authorizedCapital;
  ...
  const editCompany = () => {
    ...
    tmpCompanies[indexEditCompany].authorizedCapital =
      Number(authorizedCapital);
  ...
  const searchCompany = () => {
    ...
    const tmpCompanies = companies.filter((emp) =>
              ...
              <div className="form-post__wrapper">
                ...
                <div className="form-post__field">
                  <input
                    ...
                    type="text"
                    id="status1"
                    placeholder="Working or stopWorking"
                  />
                </div>
                <div className="form-post__field">
                  <input
          ...
          <div className="admin-post__wrapper">
            <div className="admin-post__head">
              ...
              <div style={{ right: "10px" }} className="admin-post__button">
                <button onClick={() => popUpActive()}>Thêm công ty</button>
              </div>
            </div>
              ...
              <table id="admin-post__table" className="table">
                <thead className="thead-dark">
                  <tr style={{ fontSize: "18px" }}>
                    ...
                    <th style={{ width: "200px" }}>Active Field</th>
                    ...
                    <tr key={index}>
                      ...
                      <td>
                        ...
                        >
                          ...
                          <Link
                            style={{ color: "white" }}
                            to={`/company/view-employees/${item.id}`}
                          >
                            Xem
                          </Link>
                        </button>
