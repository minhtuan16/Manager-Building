                ...
                <div className="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                  <div className="tb_work_txt_wrapper">
                    <div className="abt_txt_box">
                      ...
                      <p>
                        Hệ thống cho phép admin có thể quản lý các công ty thuê
                        văn phòng trong tòa nhà cũng như thông tin về các mặt
                        bằng mà công ty đó thuê, quản lý các dịch vụ trong tòa
                        nhà và các nhân viên tòa nhà
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="tb_work_txt_wrapper">
                    <div className="abt_txt_box">
                      <p style={{ fontSize: "20px" }}>
                        Là một công ty công nghệ, MANAGEMENTBUILDING tự hào là
                        đơn vị tiên phongcung cấp các giảI pháp phần mềm trong
                        lĩnh vực bất động sản, áp dụng các công nghệ hiện địa
                        trong xây dựng sản phẩm đảm bảo khả năng tương thích và
                        kết nối với các hệ thống khác của doanh nghiệp.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-10 col-lg-10 col-sm-10 col-xs-12">
                  <div className="tb_work_txt_wrapper">
                    <div className="abt_txt_box">
                      ...
                      <p style={{}}>
                        - Phần mềm điều khiển thiết bị nhà thông minh Smart
                        Life.
                      </p>
                      <p style={{}}>
                        - Phần mềm chat nội bộ doanh nghiệp Chatto.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-md-10 col-lg-10 col-sm-10 col-xs-12 r">
                  <div className="tb_work_txt_wrapper row">
                    ...
                    <div className="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                      ...
                      <p style={{}}>
                        Địa chỉ: Mặt tiền Đại Lộ Phạm Văn Đồng, Phường An Bình,
