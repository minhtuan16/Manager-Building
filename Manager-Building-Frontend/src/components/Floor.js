            ...
            <div className="form-post__content">
              <div className="form-post__wrapper">
                ...
                <div className="form-post__field">
                  <p style={{ textAlign: "left" }}>
                    <strong>Giá tiền/m2</strong>
                  </p>
                  <input
                    value={pricePerM2}
                    onChange={(e) => {
                      onPricePerM2Change(e);
                    }}
                    style={{ width: "100%" }}
                    type="number"
                    id="price-per-M2"
                ...
                <div className="form-post__field">
                  <p style={{ textAlign: "left" }}>
                    <strong>Diện tích tầng</strong>
                  </p>
                  <input
                    value={groundArea}
                    onChange={(e) => {
                      onGroundAreaChange(e);
                    }}
                    style={{ width: "100%" }}
                    type="number"
                    id="ground-area"
          ...
          <div className="admin-post__wrapper">
            <div className="admin-post__head">
              ...
              <div style={{ right: "10px" }} className="admin-post__button">
                <button onClick={() => addClick()}>Thêm tầng</button>
              </div>
            </div>
