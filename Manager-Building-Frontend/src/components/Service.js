...
const Service = () => {
  ...
  const editService = () => {
    ...
    if (!(validateIsPrice && validateIsRequired)) return;
              ...
              <div className="form-post__wrapper">
                ...
                <div className="form-post__field">
                  <input
                    ...
                    type="text"
                    id="is-required"
                    placeholder="Dịch vụ bắt buộc? (1 nếu có, 0 nếu ngược lại)"
                  />
                  <span
                    style={{ display: isMandatory ? "none" : "" }}
                ...
                <div className="form-post__field">
                  ...
                  />
                  <span
                    style={{ display: isPrice ? "none" : "" }}
                    className="validate-phone"
                  >
                    Nhập lượng giá phù hợp
                  </span>
                </div>
                <div className="form-post__field">
                  <input
          ...
          <div className="admin-post__wrapper">
            <div className="admin-post__head">
              ...
              <div style={{ right: "10px" }} className="admin-post__button">
                <button onClick={() => popUpActive()}>Thêm dịch vụ mới</button>
              </div>
            </div>
            <div
              style={{ fontSize: "20px", marginLeft: "-20px" }}
